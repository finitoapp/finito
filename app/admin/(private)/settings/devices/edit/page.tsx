...
import { DeviceForm } from "@/app/admin/(private)/settings/devices/device-form";
...
export default function Home() {
	...
	useEffect(() => {
		if (item === undefined) {
			router.replace("/admin/settings/devices" as never);
		}
	}, [item, router]);
	...
	return (
		<div className={"max-w-xl w-full"}>
			<div className={"mb-6"}>
				<BackButton fallbackHref={"/admin/settings/devices" as never} />
			</div>
